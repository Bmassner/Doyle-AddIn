		...
		Select Case oTheme.Name
			Case "LightTheme", "DarkTheme"
				...
				For Each icon In icons
					Dim largeIcon As stdole.IPictureDisp = PictureConverter.SvgResourceToPictureDisp(icon.Icon, iconSizes(1),
					                                                                                 iconSizes(1), themeSuffix)
					Dim smallIcon As stdole.IPictureDisp = PictureConverter.SvgResourceToPictureDisp(icon.Icon, iconSizes(0),
