'VERSION 5.00
'Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} fmTest3 
'   Caption         =   "UserForm1"
'   ClientHeight    =   4230
'   ClientLeft      =   120
'   ClientTop       =   450
'   ClientWidth     =   6165
'   OleObjectBlob   =   "fmTest3.frx":0000
...
Class fmTest3
    ...
    Private Sub UserForm_Initialize()
        ...
        For dx = 1 To 3
            ...
            ct = frmShp.Controls.Add("MSForms.CheckBox.1", cp, True) 'Me
            With ct
                .Height = 18
                .Width = 96
                .Left = 18
    ...
    Optional bk As String = " "
        ...
        With frm.Controls '.Remove
            ...
            For Each cp In Split(ls, bk)
                If Len(cp) > 0 Then
                    ctrl = .Add("MSForms.CheckBox.1", cp, True)
                    With ctrl
                        .Height = 18
                        .Width = 96
                        .Left = 18
