Class iLogicIfc
    ...
    Public Function RuleNames(
    Optional AiDoc As Inventor.Document = Nothing
) As Object
        If AiDoc Is Nothing Then
            RuleNames = dc.Keys
        Else
            RuleNames = WithRulesIn(
        AiDoc).RuleNames()
        End If
    End Function

    Public Function RuleDefs(
    Optional AiDoc As Inventor.Document = Nothing
    ...
    Public Function Apply(ruleName As String,
    ...
    Private Sub Class_Initialize()
        ...
        'WithRulesIn Nothing
        'Dim
        'WithRulesIn(Inventor.Documents.ItemByName(
